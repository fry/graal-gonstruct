#ifndef GRAAL_LEVEL_EDITOR_DISPLAY_HPP_
#define GRAAL_LEVEL_EDITOR_DISPLAY_HPP_
...
namespace Graal {
  namespace level_editor {
    ...
    public:
      ...
      // forces a redraw of the area the selection currently occupies
    ...
    protected:
      ...
      Cairo::RefPtr<Cairo::Surface> m_selection_surface;
